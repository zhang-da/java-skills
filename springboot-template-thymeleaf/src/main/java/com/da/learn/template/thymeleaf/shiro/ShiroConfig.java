package com.da.learn.template.thymeleaf.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, ShiroProjectProperties properties) {
        ...
        // 未授权错误页面  在GlobalExceptionHandler中也定义了这个路径
     ...
     */
    @Bean
    public AuthRealm getRealm(CacheManager cacheManager) {
     ...
     */
    @Bean
    public DefaultWebSessionManager getDefaultWebSessionManager(CacheManager cacheManager, ShiroProjectProperties properties) {
